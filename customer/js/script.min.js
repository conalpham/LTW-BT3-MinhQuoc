...
function addToCart(id) {
    $.post('../lib/controller.php?q=add-to-cart', {
            itemId: id
        },
        function(data) {
            getCountCart();
...
function removeItemInCart(id) {
    ...
    $.post('../lib/controller.php?q=remove-item-in-cart', {
            itemId: id
        },
        function(data) {
            getCountCart();
...
function getCountCart() {
    $.get('../lib/controller.php?q=count-cart', {}, function(data) {
        $('.cart_no').html(data);
    });
}

function getListCart() {
    $.get('../lib/controller.php?q=get-list-item-in-cart', {}, function(data) {
        $('.option-cart-item').html(data);
    })
}

$('#btnCheckout').click(function() {
    if (confirm('Bạn muốn thanh toán?')) {
        $.get('../lib/controller.php?q=checkout', {}, function(data) {
